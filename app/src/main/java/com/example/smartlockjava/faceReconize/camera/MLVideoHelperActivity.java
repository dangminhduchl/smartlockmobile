package com.example.smartlockjava.faceReconize.camera;
...
import com.example.smartlockjava.SignUpActivity;
...
public abstract class MLVideoHelperActivity extends AppCompatActivity {
    ...
    public void makeAddFaceDisable() {
        addFaceButton.setText("Retry");
        addFaceButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MLVideoHelperActivity.this, SignUpActivity.class);
